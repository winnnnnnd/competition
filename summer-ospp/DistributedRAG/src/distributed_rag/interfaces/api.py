...
from ..infrastructure.observability import refresh_runtime_metrics
...
def main() -> None:
    ...
    uvicorn.run("distributed_rag.interfaces.api:create_app", factory=True, host="0.0.0.0", port=8000)
